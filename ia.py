...
_TOOLS_SYSTEM = (
    ...
    "REGLA ANTI-COMBINACIONES: en enviar_archivo_whatsapp, cada item de 'envios' es UN "
    "contacto con SU lista de archivos ('archivos'). El campo 'archivos' de cada item debe "
    "contener EXACTAMENTE los archivos que ese contacto debe recibir — nunca asumas que un "
    "archivo va a más contactos de los pedidos explícitamente. "
    "Si el usuario pide 'A.txt y B.csv a Diana', un item: "
    "{contacto: Diana, archivos: [A.txt, B.csv]}. "
    "Si el usuario pide 'A.txt a Juan y B.csv a María', DOS items separados, cada uno con un "
    "solo archivo: [{contacto: Juan, archivos: [A.txt]}, {contacto: María, archivos: [B.csv]}] — "
    "NUNCA cruces combinaciones no pedidas explícitamente. "
